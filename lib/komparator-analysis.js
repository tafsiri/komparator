...
import defaultStopwords from './stopwords-en.js';
...
var KomparatorAnalysis = {
   ...
   * @todo
   */
  removeStopWordTokens: function(tokenList, stopwords = defaultStopwords) {
    return _.reject(tokenList, (s) => _.includes(stopwords, s.toLowerCase()));
  },
