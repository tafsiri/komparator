...
import { setMinimumFrequency, showUniqueTerms } from './actions';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <input type="checkbox" checked={options.get('showUniqueTerms')} onChange={this.updateShowUnique.bind(this)} />

        <label>Show Stopwords</label>
        <input type="checkbox" checked={options.get('showStopWords')} onChange={this.updateShowStopWords.bind(this)} />
      </div>
    );
  }
}